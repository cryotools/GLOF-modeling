...
A **template case directory** is provided in the repository, containing a working structure and the essential input files for your simulation. 
You should adapt the content of this template to your specific case.
...
│   └── turbulenceProperties ← Turbulence properties (e.g. turbulence type and model)
│
├── system/
...
│   └── blockMeshDict        ← Initial mesh generation configuration
│   └── snappyHexMeshDict    ← Refined mesh generation configuration
│
├── 0.org/                   ← Initial conditions for pressure, velocity, alpha.water, etc.
│
├── terrain/                 ← External folder for input rasters (e.g., DEMs, masks)
│                              and STL-generation scripts
